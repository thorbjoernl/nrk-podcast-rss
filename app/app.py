...
podcasts = [
    ...
    },
    {
        ...
        "url": "https://radio.nrk.no/podkast/politisk_kvarter",
        "desc": "Politisk Kvarter",
        "image": "https://gfx.nrk.no/5Bk4IWQVfNZTVR17iLNoPg-s7nfS21pUK3gEyywjzU4g",
        "fname": "politisk_kvarter",
    },
]
        ...
        if "id" in e.keys():
            if e["url"] in archive:
                ...
                try:
                    ...
                    logger.error(f"{title} - Failed to download {e['id']}")
                    logger.info(error)
                else:
                    ep = Episode()
